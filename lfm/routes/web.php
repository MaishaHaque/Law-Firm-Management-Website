...
//    Route::get('/firmleader/dashboard', [ManageController::class, 'FirmleaderDashboard'])->name('firmleader.dashboard'); #managing partner dashboard
...
Route::middleware(['auth','role:admin'])->group(function(){
    ...
    Route::get('/admin/add-employee', [AddEmployeeController::class, 'showAddEmployeeForm'])->name('admin.showAddEmployeeForm');
    Route::post('/admin/add-employee', [AddEmployeeController::class, 'addEmployee'])->name('admin.addEmployee');
    
    Route::get('/admin/assign-room', [AssignRoomController::class, 'showAssignRoomForm'])->name('admin.showAssignRoomForm');
    Route::post('/admin/assign-room', [AssignRoomController::class, 'assignRoom'])->name('admin.assignRoom');
    Route::get('/admin/unassign-room', [AssignRoomController::class, 'unassignRoom'])->name('admin.unassignRoom');
    ...
    Route::controller(CaseDetailsController::class)->group(function(){
        ...
        Route::get('/all/employee','AllEmployee' )->name('all.employee'); #all case list 
        Route::get('/admin/addemployee', 'AddEmployee')->name('add.employee');
        Route::post('/store/employee','StoreEmployee' )->name('store.employee'); #add new case to db

        Route::get('/editadmin/case/{id}','EditAdminCase' )->name('editadmin.case'); #edit case to db 
        Route::post('/update/admincase','UpdateAdminCase' )->name('editad.case'); #update admin new case to db
...
Route::middleware(['auth', 'role:firmleader'])->group(function(){
    ...
    Route::controller(CasesController::class)->group(function(){
        ...
        Route::get('/edit/cases{id}', 'EditCases')->name('edit.cases');
...
});//end group firmleader middleware
