              ...
              <div class="d-flex justify-content-center p-3 rounded-bottom">
                <ul class="d-flex align-items-center m-0 p-0">
                  ...
                  <li class="ms-3 ps-3 border-start d-flex align-items-center">
                    ...
                    <a class="pt-1px d-none d-md-block text-body" href="#">{{  $dmfcases->name }}</a>
                  </li>
            ...
            <div class="card rounded">
              <div class="card-body">
                ...
                <div class="mt-3">
                  ...
                  <p class="text-muted">{{  $dmfcases->name }}</p>
                </div>
                <div class="mt-3">
                  <label class="tx-11 fw-bolder mb-0 text-uppercase">Email</label>
                  <p class="text-muted"> {{$dmfcases->email}}</p>
                </div>
                <!--
                <div class="mt-3">
                  <label class="tx-11 fw-bolder mb-0 text-uppercase">Email:</label>
            ...
            <div class="row">
              ...
              <div class="col-md-12 grid-margin">
                <div class="card rounded">
                  ...
                  <div class="card-body">
                    <p class="mb-3 tx-14"> {{  $dmfcases->salary  }}</p>
                  </div>
              ...
              <div class="col-md-12 grid-margin">
                <div class="card rounded">
                  ...
                  <div class="card-body">
                    <p class="mb-3 tx-14"> {{  $dmfcases->position  }}</p>
                  </div>
                ...
                <div class="card rounded">
                  <div class="card-body">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-muted"> {{ $dmfcases->status }}</p>
                    </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                      <div class="d-flex align-items-center hover-pointer">										
                        <div class="ms-2">
                          <p>Joined</p>
                          <p class="tx-11 text-muted"> {{  $dmfcases->created_at }}</p>
                        </div>
                      </div>
                    </div>
