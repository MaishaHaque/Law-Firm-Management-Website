...
<div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            ...
            <h5 class="mb-3 mb-md-0">Welcome {{ $profileData->name }} </h5>
          </div>
                ...
                <div class="d-flex flex-column">
                  <a href="javascript:;" class="d-flex align-items-center border-bottom pb-3">
                    ...
                    <div class="w-100">
                      ...
                      <p class="text-muted tx-13">Dicuss about the case</p>
                    </div>
                  </a>
                  ...
                  <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                    ...
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                        <h6 class="text-body mb-2">Partners Meeting</h6>
                        
                      </div>
                      <p class="text-muted tx-13">Partners meetinng at 11 am.</p>
                    </div>
                  </a>
                  ...
                  <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                    ...
                    <div class="w-100">
                      <div class="d-flex justify-content-between">
                        <h6 class="text-body mb-2">Case 1 hearing</h6>
                        
                      </div>
                      <p class="text-muted tx-13">Attend Case hearing at 3pm.</p>
                    </div>
                  </a>
